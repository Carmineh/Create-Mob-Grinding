package dev.manny.create_ks.datagen;

import dev.manny.create_ks.CreateKineticSpawning;
import dev.manny.create_ks.event.SpawnerBreakEventHandler;
...
@EventBusSubscriber(modid = CreateKineticSpawning.MOD_ID, bus = EventBusSubscriber.Bus.MOD)
public class ModDataGen {
    ...
    public static class ModEntityTypeTagsProvider extends EntityTypeTagsProvider {
        ...
        public ModEntityTypeTagsProvider(PackOutput pOutput, CompletableFuture<HolderLookup.Provider> pProvider, ExistingFileHelper existingFileHelper) {
            super(pOutput, pProvider, CreateKineticSpawning.MOD_ID, existingFileHelper);
        }
