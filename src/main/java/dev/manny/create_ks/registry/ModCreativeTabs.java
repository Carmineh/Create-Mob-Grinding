...
public class ModCreativeTabs {
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS =
            DeferredRegister.create(Registries.CREATIVE_MODE_TAB, CreateKineticSpawning.MOD_ID);

    public static final Supplier<CreativeModeTab> KINETIC_SPAWNING_TAB = CREATIVE_MODE_TABS.register("kinetic_spawning_tab",
            () -> CreativeModeTab.builder()
                    .title(Component.translatable("itemGroup.create_ks.kinetic_spawning_tab"))
